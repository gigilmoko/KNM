        ...
        <div className="inline-block float-right">
            ...
            <div className="dropdown dropdown-bottom dropdown-end">
                ...
                <ul tabIndex={0} className="dropdown-content menu p-2 text-sm shadow bg-base-100 rounded-box w-52">
                    ...
                    <li><a onClick={() => removeAppliedFilter()}>Remosve Filter</a></li>
                </ul>
            </div>
        </div>
    )
...
function Product(){
    ...
    return(
        <>
            ...
            <TitleCard title="All Products" topMargin="mt-2" TopSideButtons={<TopSideButtons applySearch={applySearch} applyFilter={applyFilter} removeFilter={removeFilter}/>}>

          ...
          <div className="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
            <form className="login100-form validate-form" onSubmit={formik.handleSubmit}>
              ...
              <div className="register-input-container p-t-12">
                ...
                <div className="register-input-row phone-member-row p-t-30">
                  <div className="register-input-group phone">
                    <span className="register-label-input">Phone</span>
                    <input
                      className="register-input-field phone-field"
                      type="text"
                      name="phone"
                  ...
                  <div className="register-input-group member-id">
                    ...
                    <input
                      className="register-input-field member-id-field"
                      type="text"
                      name="memberId"
                ...
                <div className="register-input-row address-row p-t-30">
                  <div className="register-input-group address">
                    ...
                    <input
                      className="register-input-field address-field"
                      type="text"
                      name="address"
                      placeholder="Address"
                      onChange={formik.handleChange}
                ...
                <div className="register-input-row email-password-row p-t-30">

...
const { createEvent, updateEvent, getEvent, getAllEvents, deleteEvent, afterCurrentDay, 
    beforeCurrentDay, searchEvents, testNotifyMembers, testNotifyAllUsers, getNextThreeEvents  } = require('../controller/calendarController');
...
router.get('/calendar/events/featured', getNextThreeEvents);
